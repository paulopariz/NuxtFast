  ...
  <div v-else class="absolute left-1/2 w-full -translate-x-1/2">
    <div class="md:container w-full m-auto">
      ...
      >
        ...
        <div>
          <img
            src="../assets/img/NuxtGreen.svg"
            alt="Logo NuxtJS"
            class="w-64 max-lg:w-48 max-md:w-36 max-sm:w-28"
          />
        </div>
      </header>
      ...
      <div v-for="aula in aulasApi" :key="aula.id">
        <section
          class="mt-14 pt-4 pb-7 border-2 border-gray-200 dark:border-zinc-900 flex flex-col items-start gap-4 rounded-md transition-all hover:bg-gray-200/20 dark:hover:bg-zinc-900/20 max-sm:mt-7"
        ...
        >
          ...
          >
            <span v-if="user" class="font-bold tracking-wide max-sm:text-sm"
          ...
          >
            ...
            <p
              class="text-base tracking-wide w-4/6 leading-6 font-normal max-lg:w-5/6 max-md:w-full max-sm:text-[15px]"
            >
              {{ aula.description }}
            </p>
