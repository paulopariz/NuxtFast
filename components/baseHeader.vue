<template>
  <header
    class="border-2 border-x-0 border-t-0 pb-10 border-gray-200 dark:border-zinc-900 mb-10"
  >
    <h1
    ...
    <p
      class="tracking-wide leading-7 text-N-dark dark:text-gray-200 w-3/5 mt-3"
    >
      {{ desc }}
    </p>
  </header>
